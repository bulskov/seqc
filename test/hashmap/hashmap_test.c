...
static hashmap_t *make_str_map(growing_arena_t *a)
{
...
{
    const hashmap_entry_t *e = (const hashmap_entry_t *)elem;
    *(int *)ctx += *(int *)e->value;
}
